...
> 本文档对齐当前 Demo：**取消网吧主角色、取消网吧主分成，所有网吧录入与管理动作均由代理执行**。
...
| --- | --- | --- |
| 主体信息 | 主体类型 | 企业 / 个人 |
| 实名认证 | 企业：企业名 + 统一社会信用代码 + 营业执照；个人：实名信息 | 按主体类型切换 |
...
| 字段 | 必填 | 校验 / 说明 |
| --- | :-: | --- |
| 网吧 ID | 是 | 代理从迪越 / 区域经理获取；不知道时联系区域经理 |
| 网吧名称 | 是 | 建议带分店名以区分同名门店 |
| 所在地区 | 是 | 省 / 市级联 |
| 详细地址 | 是 | 需具体到门牌号或楼层 |
| 终端规模数 | 是 | 代理人工填写，可后续编辑 |
| 现场联系人 | 是 | 店长 / 门店负责人 |
| 联系电话 | 是 | 手机号格式 |
